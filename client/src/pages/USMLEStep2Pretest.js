...
const examStructure = [
  ...
  },
  {
    title: 'Break Time',
    value: '45 minutes',
    note: 'Can be extended if you skip the tutorial.'
  }
];

function USMLEStep2Pretest() {
  ...
  return (
    <div className="usmle-step1-pretest-page">
      ...
      <main className="usmle-step1-pretest-content">
        <section className="step1-pretest-hero" aria-label="USMLE Step 2 CK pretest overview">
          <p className="step1-pretest-kicker">USMLE Step 2 CK Pre-Test</p>
          <h1>Exam Structure</h1>
          <p>
            Use this snapshot to plan pace, stamina, and break strategy before your Step 2 CK pre-test.
          </p>
        </section>

        <section className="step1-pretest-grid" aria-label="Step 2 CK exam structure details">
        ...
        <section className="step1-pretest-summary" aria-label="Step 2 CK quick summary">
          ...
          <button
            ...
            onClick={() => navigate('/exams/usmle/step2-pretest/exam')}
          >
            Start Exam
          </button>
        </section>
...
export default USMLEStep2Pretest;
