...
const STEP_OPTIONS = [
  { value: 'STEP_1', label: 'Step 1', defaultColor: '#1e3a8a' },
  { value: 'STEP_2', label: 'Step 2 CK', defaultColor: '#1d4ed8' },
  { value: 'STEP_3', label: 'Step 3', defaultColor: '#0369a1' }
];
...
function AdminUSMLESubjects() {
  ...
  const fetchSubjects = async () => {
    try {
      ...
      console.error('Error fetching USMLE subjects:', error);
      setSubjects([]);
    } finally {
      setLoading(false);
    }
  ...
  if (loading) {
    return <div className="admin-usmle-loading">Loading USMLE subjects...</div>;
  }
  ...
  return (
    <div className="admin-usmle-subjects">
      <header className="usmle-admin-header">
        <div>
          <h1>USMLE Subjects Management</h1>
          <p>Manage subject lists for Step 1, Step 2 CK, and Step 3.</p>
        </div>

        <div className="usmle-admin-actions">
          <button className="btn-secondary" onClick={() => navigate('/admin/dashboard?section=usmle-admin')}>
            Back to USMLE Admin
          </button>
        ...
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-card" onClick={(event) => event.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <label htmlFor="step">USMLE Step</label>
...
export default AdminUSMLESubjects;
