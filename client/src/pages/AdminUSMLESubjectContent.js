...
const getStepLabel = (step) => {
  if (step === 'STEP_1') return 'STEP 1';
  if (step === 'STEP_2') return 'STEP 2 CK';
  if (step === 'STEP_3') return 'STEP 3';
  return step || 'USMLE';
};

function AdminUSMLESubjectContent() {
            ...
            <div className="modal-body">
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="e.g., Renal Disorders"
...
export default AdminUSMLESubjectContent;
