...
function USMLEStep1PretestReview() {
  ...
  const examMode = typeof window !== 'undefined' ? localStorage.getItem(USMLE_PRETEST_MODE_KEY) : 'professional';
    ...
    return (
      <div className="plab1-test-page">
        ...
        <main className="plab1-test-wrapper">
          ...
          <button className="review-primary" onClick={() => navigate('/exams/usmle/step1-pretest/exam')}>
            Start Exam
          </button>
        </main>
        <Footer />
  ...
  return (
    <div className="plab1-test-page">
      ...
      <main className="plab1-test-wrapper">
        <h1>USMLE Step 1 Pre-Test Review</h1>
        ...
        <div className="review-actions">
          ...
          {examMode === 'professional' && (
            <button className="review-secondary" onClick={() => navigate('/exams/usmle/step1-pretest')}>
              Exit the exam page
            </button>
          )}
        </div>
...
export default USMLEStep1PretestReview;
