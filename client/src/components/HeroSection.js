      ...
      <div className="hero-container">
        ...
        <div className="hero-content">
          ...
          <div className="hero-exams-section">
            ...
            <div className="exam-tabs-layout">
              {exams.map((exam, idx) => (
                <div 
                  key={exam.id} 
                ...
                >
                  <div className="tab-left-stripe" style={{ backgroundColor: exam.color }}></div>
                  <div className="tab-icon" style={{ backgroundColor: exam.bgColor, color: exam.color }}>
                    {exam.icon}
                  </div>
